...
absl::StatusOr<uint64_t> IfrtBackend::HandleGenerator::FromClientManufactured(
...
absl::Status IfrtBackend::HandleGenerator::FromClientManufacturedBulk(
...
IfrtBackend::HandleAssembleArrayFromSingleDeviceArraysRequest(
  ...
  TF_ASSIGN_OR_RETURN(uint64_t handle, handle_generator_.FromClientManufactured(
...
IfrtBackend::HandleRemapArraysRequest(std::unique_ptr<IfrtRequest> request) {
  ...
  TF_RETURN_IF_ERROR(handle_generator_.FromClientManufacturedBulk(
...
IfrtBackend::HandleFullyReplicatedShardRequest(
  ...
  TF_ASSIGN_OR_RETURN(uint64_t new_array_handle,
                      handle_generator_.FromClientManufactured(
